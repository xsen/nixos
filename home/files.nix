...
in
{
  home.file = {
    ...
    ".config/zed/settings.json".source =
      config.lib.file.mkOutOfStoreSymlink "${nixConfigDir}/home/zed/settings.json";
    ".config/zed/keymap.json".source =
      config.lib.file.mkOutOfStoreSymlink "${nixConfigDir}/home/zed/keymap.json";
    ...
    ".gemini/antigravity-cli/settings.json" = {
      source = config.lib.file.mkOutOfStoreSymlink "${nixConfigDir}/home/antigravity/cli-settings.json";
      force = true;
    };
    ...
    ".gemini/antigravity-cli/statusline-command.sh".source =
      config.lib.file.mkOutOfStoreSymlink "${nixConfigDir}/home/antigravity/statusline-command.sh";
